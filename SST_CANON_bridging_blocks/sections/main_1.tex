...
\begin{aligned}
&\text{(D6) EJA ratios:} && \frac{\sqrt{m}_{\rm mid}}{\sqrt{m}_{\rm heavy}} = \frac{s}{s+\delta},\quad
\frac{\sqrt{m}_{\rm light}}{\sqrt{m}_{\rm mid}} = \frac{s-\delta}{s},\quad \delta^2 = \tfrac{3}{8}.\\[4pt]
...
&\text{(B3_{\rm SM}) ASG difference:} && y_{t,*}^2-y_{b,*}^2 = \tfrac{1}{3}g_{Y,*}^2.\\[4pt]

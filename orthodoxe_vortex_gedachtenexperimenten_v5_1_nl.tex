...
\title{Orthodoxe gedachtenexperimenten over vortexpatches, superfluïde roosters en geknoopte vortexstructuren}
\author{}
\date{}
...
\section{Orthodoxe gedachtenexperimenten over vortexpatches, superfluïde roosters en geknoopte vortexstructuren}
...
Gebruik dit eerst als lokaal modelvolume. Neem daarna de limiet waarin de cilinderwand ver weg staat en niet de primaire rotatiebron is.
    ...
    \subsection*{Kerninterpretatie: depleted superfluïde kern versus gevuld substraat}
        
        Wanneer in orthodoxe superfluïde fysica wordt gesproken over een vortexkern, betekent dit gewoonlijk een kern waarin de ordeparameter of de effectieve superfluïde dichtheid onderdrukt is. In een Gross--Pitaevskii- of BEC-beschrijving verschijnt de vortexlijn daarom als een dichtheidsdepletie of ``hollow core'' op de schaal van de healing length \(\xi\).
        
        Deze terminologie mag echter niet worden verward met een absoluut lege kern. In een dieper substraatbeeld, waarin de dragende mediumlaag zelf onsamendrukbaar en ruimtevullend is, kan de vortexkern niet letterlijk hol zijn. De vloeistofdeeltjes of substraatelementen kunnen nergens heen om een vacuümholte te vormen. De kern is dan beter te modelleren als een gevulde Rankine-, Hill- of vortexpatch-achtige kern waarin het onderliggende substraat aanwezig blijft en de vorticiteit intern wordt gedragen.
        
        Daarom worden in deze vragenlijst twee niveaus onderscheiden:
        \[
            \text{orthodoxe superfluïde laag: gedepleteerde ordeparameterkern,}
        \]
        \[
            \text{diepere incompressibele substraatlaag: gevulde vortexkern.}
        \]
        
        In de orthodoxe controlelaag blijft de gebruikelijke superfluïde terminologie bruikbaar. Voor het diepere substraatmodel moet echter worden gelezen:
        \[
            \boxed{
                \text{``hollow core'' betekent alleen een effectieve depletie van de superfluïde ordeparameter, niet een lege kern van het onderliggende medium.}
            }
        \]
        
        Voor Rankine- en Hill-achtige vortexkernen geldt in het substraatbeeld:
        \[
            \boxed{
                \text{de kern is fluid-filled, niet hol.}
            }
        \]

...
%! License = © 2025 Omar Iskandarani. Preprint version.
%! ORCID = 0009-0006-1686-3961
%! DOI = 10.5281/zenodo.17905207

\newcommand{\paperdoi}{10.5281/zenodo.17905207}
\newcommand{\papertitle}{A Compact Algebraic Relation Among Standard Electron Scales}
\newcommand{\PDFpapertitle}{A Compact Algebraic Relation Among Standard Electron Scales}
...
\begin{document}
    ...
    \begin{abstract}
        ...
        \]
        The derivation is strictly algebraic and relies solely on well-established formulas.
        The oscillator construction is introduced purely as a bookkeeping device for combining standard definitions and is not intended as a physical model of the electron.
        We discuss the historical origin of the underlying scales (classical electron models, Compton scattering, Bohr's hydrogen theory) and comment on the structural interdependence of atomic, relativistic, and classical electromagnetic quantities revealed by this identity.
    \end{abstract}
    ...
    \section{A minimal algebraic construction}
        ...
        Consider a one-dimensional oscillator of mass $m_e$, angular frequency $\omega_\ast$, and maximal displacement $x_{\max}$. Hooke's law gives the maximal restoring force
            ...
            The quantities introduced in Eq.~\eqref{eq:osc-choices} serve only as a convenient parametrization for combining standard electron scales.
            No physical interpretation of the electron as an oscillator or extended object is assumed or required.
        ...
        \begin{figure}[t]
            ...
            \begin{tikzpicture}[x=1cm,y=1cm]
                ...
                (-0.6,0) -- (1.3,0);
            \end{tikzpicture}
            \caption{Schematic illustration of the algebraic construction used to combine standard electron scales. The diagram is not intended as a physical model.}
    ...
    \section{Conclusion}
        ...
        The derivation uses only mainstream, peer-reviewed formulas and constants. Any deeper physical interpretation of this identity would require additional assumptions beyond those used here and lies explicitly outside the scope of the present work.

    \appendix
    \section{Heuristic analogy (optional)}

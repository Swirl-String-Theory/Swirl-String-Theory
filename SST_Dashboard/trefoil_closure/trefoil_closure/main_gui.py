...
def evaluate_functional(R, r, p, q, N_points=1000):
    ...
    C_N = sst_closure_lab.calculate_neumann_self_energy(points, r_c)
    L_K = sst_closure_lab.calculate_length(points)
    Wr = sst_closure_lab.calculate_writhe(points, r_c)
    U_rep_val = sst_closure_lab.calculate_core_repulsion(points, r_c)

    # 5. Buigingsstijfheid (Kromming)
    K_K = sst_closure_lab.calculate_curvature_penalty(points)

...
\newcommand{\papertitle}{Swirl--Clock Phase Locking in Closed Circulation Loops}
...
Consider a continuous excitation propagating on a closed loop of fixed geometric length $L$ with characteristic transport speed $\mathbf{v}\textit{!\boldsymbol{\circlearrowleft}}$. The closed geometry defines a finite circulation or round--trip time
\begin{equation}
\tau = \frac{L}{\lVert \mathbf{v}}{!\boldsymbol{\circlearrowleft}} \rVert,
\end{equation}

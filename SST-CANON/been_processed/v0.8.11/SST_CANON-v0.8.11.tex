...
%! DOI = 10.5281/zenodo.21155972
%! v0.8.11 edition: final notation hygiene pass (been_processed).
...
\newcommand{\paperdoi}{10.5281/zenodo.21155972}
\newcommand{\papertitle}{Swirl-String-Theory Canon-v0.8.11}
\newcommand{\paperkeywords}{Swirl String Theory, SST, Canon, Topological Hydrodynamics, Knot Theory, Relational Time, Delay Dynamics, Epistemic Classification, notation hygiene, EMG correspondence}
...
% ---------------------------
        \newpage
        \input{SST_CANON-v0.8.11-research-track}

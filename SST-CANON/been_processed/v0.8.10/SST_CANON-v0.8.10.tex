...
%! DOI = 10.5281/zenodo.21155888
%! v0.8.10 edition: Round-2 calibration notation audit (been_processed).
...
\newcommand{\paperdoi}{10.5281/zenodo.21155888}
\newcommand{\papertitle}{Swirl-String-Theory Canon-v0.8.10}
\newcommand{\paperkeywords}{Swirl String Theory, SST, Canon, Topological Hydrodynamics, Knot Theory, Relational Time, Delay Dynamics, Epistemic Classification, swirl clock, vchar discipline}
...
% ---------------------------
        \newpage
        \input{SST_CANON-v0.8.10-research-track}

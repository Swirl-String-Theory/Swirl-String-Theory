...
%! v0.8.19 edition: ropelength foundation + screening scalarization + thin-filament energy + mass audit + impedance bridge + audit bundle + Foucault RT + projected vorticity frequency (been_processed).

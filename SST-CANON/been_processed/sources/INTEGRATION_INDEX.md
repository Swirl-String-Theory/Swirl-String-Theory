...
| `v0.8.19_rhoF_cosmological_impedance_rt.patch` | **v0.8.19** RT (in-place) | `sec:rt_rhof_cosmological_impedance_route`; `eq:rt_rhof_lambda_chi`; horn-eff density label fix |
| `v0.8.19_rhoF_cosmological_impedance_block.tex` | **v0.8.19** RT (reference) | Insert body for cosmological-impedance subsection |
...
## Additional sources (moved from `SST-CANON/` root)

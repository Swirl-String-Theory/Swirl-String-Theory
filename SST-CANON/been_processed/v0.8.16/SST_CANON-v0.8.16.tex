...
%! DOI = 10.5281/zenodo.21207587
%! v0.8.16 edition: pressure-optical locking and no-monopole audit (been_processed).
...
\newcommand{\paperdoi}{10.5281/zenodo.21207587}
\newcommand{\papertitle}{Swirl-String-Theory Canon-v0.8.16}
\newcommand{\paperkeywords}{Swirl String Theory, SST, Canon, Topological Hydrodynamics, Knot Theory, Relational Time, Delay Dynamics, Epistemic Classification, pressure-optical locking, no-monopole audit, relativity falsifier}
...
% ---------------------------
        \newpage
        \input{SST_CANON-v0.8.16-research-track}

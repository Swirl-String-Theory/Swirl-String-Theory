...
\hline
\end{tabularx}
\caption{Minimal knot-class and analogue summary (v0.8.20 research-track), aligned with main canon semantic corrections.}
...
\subsubsection{Contact-map refinement of the topological kernel}\subsubsection{Contact-pressure saturation and Swirl-Clock shielding}

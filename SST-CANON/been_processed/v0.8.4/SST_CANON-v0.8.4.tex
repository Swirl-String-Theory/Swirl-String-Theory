...
%! DOI = 10.5281/zenodo.21138951
%! v0.8.4 edition: framed-tube ontology, trefoil closure discipline, particle dictionary (been_processed).
...
\newcommand{\paperdoi}{10.5281/zenodo.21138951}
\newcommand{\papertitle}{Swirl-String-Theory Canon-v0.8.4}
\newcommand{\paperkeywords}{Swirl String Theory, SST, Canon, Topological Hydrodynamics, Knot Theory, Relational Time, Delay Dynamics, Epistemic Classification, EM-gravity bridge, fine-structure constant}
...
\section{Formal Foundations}
    ...
    \label{sec:Fmax}
        ...
        \textbf{[DERIVED]} The maximal Coulomb repulsion at the canonical circulation scale is exactly four times $F_{\rm swirl}^{\max}$. The factor of four matches the denominator structure of Eq.~\eqref{eq:Fgr} and is not numerically coincidental within the canonical chain.
...
% ---------------------------
        \newpage
        \input{SST_CANON-v0.8.4-research-track}

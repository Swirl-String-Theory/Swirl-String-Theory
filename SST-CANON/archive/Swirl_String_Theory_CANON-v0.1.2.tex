...
%----------------------------------------------------------------------
    ...
    \begin{itemize}
        \item Vortex tangential velocity: $\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} = 1.09384563 \times 10^{6}\ \si{m.s^{-1}}$.
...
%----------------------------------------------------------------------
    ...
    \begin{enumerate}
        ...
        \item $G_{\text{swirl}}=\dfrac{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} c^5 t_p^2}{2F_{\text{\ae}}^{\max} r_c^2}$
...
%----------------------------------------------------------------------
    ...
    \[
        \boxed{\alpha = \tfrac{2 C_e}{c}}\quad\Leftrightarrow\quad \boxed{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} = \tfrac{c\,\alpha}{2}},\qquad
        \boxed{\alpha_g = \tfrac{C_e^{2} t_p^{2}}{r_c^{2}}},
    \]
    \[
        \boxed{G = \tfrac{\alpha_g c^{3} r_c}{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} M_e} = \tfrac{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} c\, (c t_p)^{2}}{r_c M_e}},
        \quad

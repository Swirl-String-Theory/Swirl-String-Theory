...
% ------------------------
                \begin{scope}[xshift=-4cm]
                    \draw (0,0) circle (1.2);
                    \node at (0,-1.7) {\small Unknot};
                    \node at (0,-2.3) {\small $k=1,\; n=1,\; g=0$};
                \end{scope}

% ------------------------
% Panel B: Trefoil Knot
% ------------------------
                \begin{scope}[xshift=0cm]
                    \draw plot [smooth, tension=0.8]
                    coordinates {
                        (0,1.2) (1.0,0.4) (0.4,-0.9)
                        (-0.6,-0.6) (-1.0,0.5) (0,1.2)
                    };
                    \draw plot [smooth, tension=0.8]
                    coordinates {
                        (0,-1.2) (1.0,-0.4) (0.6,0.9)
                        (-0.4,0.6) (-1.0,-0.5) (0,-1.2)
                    };
                    \node at (0,-1.7) {\small Trefoil knot $3_1$};
                    \node at (0,-2.3) {\small $k=3,\; n=1,\; g=1$};
                \end{scope}

% ------------------------
% Panel C: Three-component link
% ------------------------
                \begin{scope}[xshift=4cm]
                    \draw (-0.5,0) circle (1.0);
                    \draw (0.5,0) circle (1.0);
                    \draw (0,-0.6) circle (0.6);
                    \node at (0,-1.7) {\small Three-component link};
                    \node at (0,-2.3) {\small $n=3,\; g\ge 0$};
                \end{scope}
            ...
            \caption{
                Visualizing the topological invariants entering the invariant kernel
                $\mathcal{K}(T)$.
                The kernel acts as a geometric filter, suppressing the effective energy
                density for configurations of increasing topological complexity through
                $(k,g,n)$.
            }
            \label{fig:topology_kernel}
        \end{figure}

...
\begin{document}
    ...
    \begin{abstract}
        We analyze a generally covariant variational framework consisting of a Lorentzian
        metric, a unit timelike vector field subject to a normalization constraint, and
        minimally coupled matter.
        Within this framework, and without assuming Lorentz invariance, geodesic motion,
        or the weak equivalence principle \emph{a priori}, we identify a common set of
        structural conditions under which these features arise in the infrared.

        We show that local kinematics reduce to the standard special-relativistic form in
        tangent-space inertial frames at each spacetime point, yielding the usual proper-time
        relation, Lorentz factor, and energy--momentum mass-shell relation.
        Variation of the total action with respect to the metric yields Einstein-form field
        equations with a covariantly conserved total stress--energy tensor.
        For minimally coupled, structureless matter, covariant conservation implies metric
        geodesic motion and therefore universality of free fall.

        General relativity is recovered as a consistent sector when the stress contribution
        of the unit-timelike field vanishes, while departures are parameterized by the
        additional timelike sector and constrained by standard preferred-frame and
        gravitational-wave speed bounds.
        The main result is a theorem-level statement about logical interdependence within a
        specified covariant variational class: local relativistic kinematics, Einstein-form
        gravitational dynamics, and universal free fall need not be introduced as independent
        axioms in that class.
    \end{abstract}
    ...
    \section{Introduction and Scope}
        ...
        \subsection{Relation to Existing Frameworks and Statement of Novelty}

            The field content and two-derivative covariant structure considered here are
            mathematically related to Einstein--\AE ther and other vector--tensor theories
            \cite{jacobsonmattingly2001,jacobson2008}.
            Accordingly, the present work does not claim to introduce a new class of
            generally covariant vector--tensor Lagrangians, nor does it derive new closed-form
            expressions for the standard preferred-frame parameters beyond the established
            literature.

            The contribution of this paper is instead structural.
            We formulate and prove a unified implication chain within this covariant
            variational class:
            local tangent-space special-relativistic kinematics, Einstein-form metric field
            equations with covariant stress conservation, and universality of free fall for
            minimally coupled matter arise as interlocked consequences of diffeomorphism
            invariance, variational consistency, and minimal coupling.
            In this sense, the result is a theorem about logical dependence within an
            effective field-theoretic framework, rather than a proposal of a new
            phenomenological gravity model.

            The analysis is carried out entirely at the level of effective field theory and
            remains agnostic regarding microscopic or ultraviolet completion.

        \subsection{Scope and Limitations}

            This paper establishes a theorem-level structural result within a class of
            generally covariant metric-plus-unit-timelike-field effective theories.
            It identifies sufficient conditions under which local relativistic kinematics,
            Einstein-form gravitational dynamics, and universal free fall arise together in
            the infrared.

            The paper does not claim uniqueness of the unit-timelike sector, does not provide
            a complete classification of strong-field solutions, and does not address
            quantization or ultraviolet completion.
            The observational discussion is correspondingly limited to standard weak-field
            consistency conditions (PPN and gravitational-wave speed constraints) used to
    ...
    \section{Main Unification Theorem}
        ...
        \subsection{Statement of the Theorem}
            ...
            \begin{enumerate}
                \item \emph{Local tangent-space special-relativistic kinematics.}
    ...
    In this work we have shown that, within a specified generally covariant
    variational framework based on a Lorentzian metric, a unit timelike field, and
    minimal coupling of matter, local special-relativistic kinematics, Einstein-form
    gravitational dynamics, and the universality of free fall need not be introduced
    as logically independent postulates.
    Instead, they arise as interlocked consequences of covariance, variational
    consistency, and minimal coupling in that framework.
    ...
    \textbf{Author Contributions} Omar Iskandarani: Conceptualization, formal analysis, derivation, writing---original draft, writing---review and editing.

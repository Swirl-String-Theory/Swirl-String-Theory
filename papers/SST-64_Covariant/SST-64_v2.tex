...
\noindent\textbf{SST-corpus status note.}
This manuscript is an effective covariant vector--tensor bridge.  It assumes a
Lorentzian metric and the Einstein--Hilbert action; it therefore derives local
SR kinematics, Einstein-form field equations, and geodesic universality
\emph{inside} that assumed variational structure.  It is not, by itself, a
derivation of the Einstein field equations from the primitive incompressible
SST substrate.  The latter remains the research target of the Relativity
Emergence Ladder.
\end{mdframed}

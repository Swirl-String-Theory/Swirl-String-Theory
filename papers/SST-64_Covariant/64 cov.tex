...
\begin{document}
    ...
    \begin{abstract}
        ...
        behavior are shown to rest on logically distinct assumptions. We also summarise
        the post-Newtonian constraint structure: $\gamma=\beta=1$ under the standard
        asymptotic-alignment boundary condition, while preferred-frame parameters and
        the gravitational-wave speed furnish the operative observational bounds.
    \end{abstract}
    ...
    \section{Introduction and Scope}
        ...
        \citep{einstein1905,einstein1915,will2014}. A natural foundational question is
        ...
        \citep{jacobson2001,jacobson2008}. The novelty claim is therefore limited and
        should be stated precisely: the individual ingredients are not new, and no new
        fundamental physics is derived here. Rather, the contribution is the joint,
        explicit, and logically decomposed presentation of which assumptions enforce
        which relativistic properties inside one common variational framework.
...
follows in the test-body limit from covariant matter conservation.
        ...
        literature \citep{foster2006,will2014}.
...
metric only.
    ...
    \section{Local Kinematics}
        ...
        \citep{misner1973,carroll2004,will2014}; the vector field $u^\mu$ plays no role
    ...
    \section{Covariant Action and Field Equations}
        ...
        \citep{jacobson2001,jacobson2008}
        \begin{equation}
        ...
        sector, not the absence of all \emph{background-dependent} tidal effects in
        extended or self-gravitating systems. Composition-dependent or
        Nordtvedt-type deviations can arise beyond the test-body approximation and are
        naturally described in the PPN framework \citep{foster2006,will2014}.
    ...
    \section{Weak-Field and PPN Constraints}
        ...
        \subsection{The parameters $\gamma$ and $\beta$}
            ...
            \citep{will1993,will2014}. For Einstein--\AEther{} theory, one obtains
            \begin{equation}
                \gamma=1,\qquad \beta=1
            \end{equation}
            for the standard class of asymptotically flat solutions in which the æther field
            is asymptotically aligned with the rest frame of the gravitating source
            \citep{foster2006}. This should be understood as a result conditional on that
            boundary condition, not as an unconditional theorem of the theory.
        
        \subsection{Preferred-frame parameters}
            
            Preferred-frame effects are encoded in $\alpha_1$ and $\alpha_2$. Following
            \citet{foster2006},
            \begin{align}
                \alpha_1 &=
                -\frac{8(c_3^2+c_1c_4)}
            ...
            \begin{equation}
                ...
                c_{14}\equiv c_1+c_4.
            \end{equation}
            Current experimental bounds require approximately
            \begin{equation}
                |\alpha_1|\lesssim 10^{-4},
                \qquad
                |\alpha_2|\lesssim 10^{-7},
            \end{equation}
            which strongly restrict the allowed coupling region \citep{will2014}.
        ...
        \subsection{Gravitational-wave speed}
            ...
            \end{equation}
            to very high accuracy \citep{abbott2017gw,abbott2017mm}. In that regime the
            viable parameter space collapses onto a narrow subspace additionally constrained
            by \cref{eq:alpha1,eq:alpha2}.
...
self-gravitating, or compositionally structured systems.
    ...
    \section{Summary and Outlook}
        ...
        bodies arise from distinct structural assumptions. The paper does not claim new
        physics beyond the Einstein--\AEther{} literature. Its contribution is instead a
        ...
        conditional. The equalities $\gamma=\beta=1$ hold for the standard
        asymptotic-alignment boundary condition \citep{foster2006}, while the real
        observational pressure comes from preferred-frame bounds and the gravitational
        wave speed constraint $c_{13}\approx 0$.
    ...
    \section*{Acknowledgements}
        The author thanks the anonymous referee for comments that significantly improved
        the framing, scope, and precision of the manuscript.
        ...
        \begin{thebibliography}{99}
            ...
            \newblock \emph{PoS(QG-PH)}, 020, 2008.

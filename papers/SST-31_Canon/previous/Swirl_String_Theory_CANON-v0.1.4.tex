...
\begin{itemize}
    \item Vortex tangential velocity: $\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} = 1.09384563 \times 10^{6}\;\mathrm{m}\,\mathrm{s}^{-1}$
...
%========================
    ...
    \begin{itemize}
        \item \([{\rm Empirical}]\) \(\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} = 1.09384563\times 10^6\,\mathrm{m\,s^{-1}}\) via metrology \(C_e=f\,\Delta x\).
...
\begin{enumerate}
    ...
    \item \textbf{$G$ coupling:} \fbox{$G_{\text{swirl}} = \dfrac{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} c^5 t_p^2}{2F_{\text{\ae}}^{\max} r_c^2}$}

...
\begin{document}
    ...
    \[
        \boxed{\ G = \frac{\alpha_g c^{3} r_c}{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} M_e} = \frac{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} c\, \ell_p^{2}}{r_c M_e}\ }\;\equiv\; G_{\mathrm{swirl}}\,.
    \]
    ...
    \begin{enumerate}
        ...
        \item $\boxed{G_{\mathrm{swirl}} = \dfrac{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} c^5 t_p^2}{2F_{\aeether}^{\max} r_c^2}}$

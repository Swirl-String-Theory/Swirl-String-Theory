...
\newcommand{\canonversion}{\textbf{v0.5.11}} % Semantic versioning: vMAJOR.MINOR.PATCH
...
% ===========================================
    \section{Quantum Computing Sector}
    \subsection*{Canon Corollary: Visibility–Rate Normalization (Radiation Sector)}
...
% -------------------------------------------
    ...
    \subsection*{Constitutive Model: SST Two-Level (R/T) Control Equations}
...
% -------------------------------------------
    ...
    \subsection*{Research Corollary: Linkage Entanglement Bus and Gate Rates}

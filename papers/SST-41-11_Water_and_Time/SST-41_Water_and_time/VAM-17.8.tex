...
\;=\; 2\,C_e\,\frac{R}{\ell_*},
\qquad
t_{\mathrm{arr}}\;\equiv\;\frac{H}{c_{g,z}}\;\sim\;\frac{H\,\ell_*}{2 \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} R}\;.
}
...
\]
\[
t_{\mathrm{arr}}\sim \frac{H\,r_c}{2\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} R}\approx 2.6\times 10^{-21}\ \mathrm{s}.
\]
\end{enumerate}
...
\paragraph{Dimensional checks.}
In \eqref{eq:arrive-aether}, $[H\,\ell_* /(\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} R)]=\mathrm{s}$. In \eqref{eq:eta-aether}, $[2\Omega_* L U/g]=\mathrm{m}$.
...
(1) Substituting $\Omega\to C_e/\ell_*$ in \eqref{eq:disp-aether} \emph{without} a medium that actually supplies such a Coriolis term is not physical; ordinary water responds to $\Omega_{\text{lab}}$, not to $C_e$. (2) At very large $\Omega_*$ or $c_{\mathrm{P}}$, dispersion and dissipation of the true microscopic medium will bound signal speeds; equations above set the \emph{kinematic ceiling}. (3) Any claim of superluminal signaling must rely on \emph{front velocity} and pass exhaustive EM/acoustic leakage controls \cite{Brillouin1960}.
    ...
    \begin{thebibliography}{9}
        ...
        doi:\href{https://doi.org/10.1017/CBO9780511800955}{10.1017/CBO9780511800955}

        \bibitem{Vallis2017}
        G.~K. Vallis,
        \emph{Atmospheric and Oceanic Fluid Dynamics}, 2nd ed.,
        Cambridge University Press, 2017.
        doi:\href{https://doi.org/10.1017/9781107588417}{10.1017/9781107588417}
        ...
        \emph{The Astrophysical Journal Letters} \textbf{848}, L13 (2017).

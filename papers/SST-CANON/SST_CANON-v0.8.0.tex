...
\newcommand{\paperdoi}{10.5281/zenodo.19655881}
\newcommand{\papertitle}{Swirl-String-Theory Canon-v0.8.0}
...
\section{Formal Foundations}
    ...
    \subsection{Reparametrized Zero-Parameter Corollary}
        ...
        Older SST canon layers often used the triplet $(\Gamma_0,\rhoF,\rc)$ as the primitive parameterization. In the present v0.8.0 architecture, Eq.~\eqref{eq:rc_definition} and Eq.~\eqref{eq:gamma0} show that this is a reparameterization of the present primitive set $(\rhoF,\vswirl,\omega_c)$ rather than a distinct axiom.
...
\section{Swirl--Electromagnetic Bridge}
    ...
    \subsection{Swirl pressure law}
        ...
        \textbf{[DERIVED SST ROLE]}: this pressure law is the canonical bridge between localized circulation and large-scale force analogies.
...
\section{Unified Interpretation}
    ...
    \subsection{Integration policy (v0.5.12 reintegration)}
        ...
        This block records only material from earlier SST canon layers that can be retained inside the v0.8.0 architecture without weakening the explicit classification discipline of Section~\ref{sec:consistency}.
    ...
    \subsection{Integration Policy}
        ...
        v0.8.0 architecture \emph{without} weakening the epistemic classification framework of
    ...
    \subsection{Particle-Candidate Mapping Layer}
        ...
        \begin{table}[h]
        \centering
        \caption{Minimal knot-class to particle-candidate summary retained in v0.8.0.}
    ...
    \subsection{Numerical Benchmark Layer}
        ...
        atomic masses. In v0.8.0, the benchmark layer is retained as a reproducibility requirement rather than as a
    ...
    \subsection{Gauge-Sector Roadmap}
        ...
        \textbf{[CRITICAL NOTE]} The gauge layer is retained in v0.8.0 only as a roadmap statement. Running couplings,
    ...
    \subsection{What v0.8.0 now recovers from v0.5.12}
    ...
    \subsection{Open items that remain outside the present closure}
        ...
        \begin{itemize}
            ...
            \item a unique dark-sector taxonomy with experimentally anchored observables.
        \end{itemize}
    ...
    \subsection{What v0.8.0 Now Retains}
    ...
    \subsection{What is Deliberately Not Claimed}
        ...
        These omissions are deliberate. v0.8.0 is intended to remain logically strict even when phenomenological

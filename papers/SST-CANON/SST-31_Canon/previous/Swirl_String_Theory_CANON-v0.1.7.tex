...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item \textbf{G coupling:} $G_{\text{swirl}} = \frac{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} c^5 t_p^2}{2 F_{\text{\ae}}^{\max} r_c^2}$.
    ...
    \begin{itemize}
        ...
        \[
            \boxed{\alpha = \frac{2 C_e}{c}} \qquad \Longleftrightarrow \qquad \boxed{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} = \frac{c\,\alpha}{2}}
        \]
        ...
        \[
            \boxed{G = \frac{\alpha_g c^{3} r_c}{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} M_e} = \frac{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} c\, \ell_p^{2}}{r_c M_e}}
        \]
        ...
        \[
            \boxed{G_{\text{swirl}}=\frac{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} c^{5} t_p^{2}}{2 F_{\text{\ae}}^{\max} r_c^{2}}}
        \]

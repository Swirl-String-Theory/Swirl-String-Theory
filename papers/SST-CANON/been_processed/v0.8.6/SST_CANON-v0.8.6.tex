...
%! DOI = 10.5281/zenodo.21155561
%! v0.8.6 edition: framed self-linking and spinorial lepton ladder (been_processed).
...
\newcommand{\paperdoi}{10.5281/zenodo.21155561}
\newcommand{\papertitle}{Swirl-String-Theory Canon-v0.8.6}
\newcommand{\paperkeywords}{Swirl String Theory, SST, Canon, Topological Hydrodynamics, Knot Theory, Relational Time, Delay Dynamics, Epistemic Classification, framed self-linking, spinorial lepton ladder}
...
% ---------------------------
        \newpage
        \input{SST_CANON-v0.8.6-research-track}

...
%! DOI = 10.5281/zenodo.21155631
%! v0.8.7 edition: Z2 spinstats sector and CP1 substrate discipline (been_processed).
...
\newcommand{\paperdoi}{10.5281/zenodo.21155631}
\newcommand{\papertitle}{Swirl-String-Theory Canon-v0.8.7}
\newcommand{\paperkeywords}{Swirl String Theory, SST, Canon, Topological Hydrodynamics, Knot Theory, Relational Time, Delay Dynamics, Epistemic Classification, Z2 spinstats, CP1 substrate}
...
% ---------------------------
        \newpage
        \input{SST_CANON-v0.8.7-research-track}

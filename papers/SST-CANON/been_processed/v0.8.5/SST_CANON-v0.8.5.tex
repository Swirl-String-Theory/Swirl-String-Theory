...
%! DOI = 10.5281/zenodo.21155520
%! v0.8.5 edition: highres conversation audit + CALIBRATED circularity honesty (been_processed).
...
\newcommand{\paperdoi}{10.5281/zenodo.21155520}
\newcommand{\papertitle}{Swirl-String-Theory Canon-v0.8.5}
\newcommand{\paperkeywords}{Swirl String Theory, SST, Canon, Topological Hydrodynamics, Knot Theory, Relational Time, Delay Dynamics, Epistemic Classification, circularity audit, calibrated inputs}
...
% ---------------------------
        \newpage
        \input{SST_CANON-v0.8.5-research-track}

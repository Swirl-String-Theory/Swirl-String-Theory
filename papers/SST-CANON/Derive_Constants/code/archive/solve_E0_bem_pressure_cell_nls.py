...
def main() -> None:
    ...
    parser.add_argument("--pressure-kappa-mode", choices=["input", "nls_log_core", "nls_velocity_core", "nls_geometric_mean", "ropelength"], default="input")
    ...
    print("pressure_kappa_mode=nls_log_core or nls_geometric_mean; these are")
    print("non-fitted Golden-NLS core-branch diagnostics, not proof-grade validation.")

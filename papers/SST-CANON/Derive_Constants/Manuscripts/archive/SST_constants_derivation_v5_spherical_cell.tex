...
Trefoil log coeff. & $\AK$                      & Numerical closure & $\AK\to1/(4\pi)$ in ideal limit \\
Spherical cell factor & $\Xsph$                 & Closure candidate & Prop.~\ref{prop:spherical_alpha} \\
Cell prediction for FSC & $\alpha_{\rm cell}$    & Conjectural     & Eq.~\eqref{eq:alpha_spherical_prediction} \\
...
from the primitive field equations.

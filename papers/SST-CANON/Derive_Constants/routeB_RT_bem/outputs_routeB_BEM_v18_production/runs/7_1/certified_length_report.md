...
- `reference`: `0_1`
- `normalizer`: `M_Lcert2`
- `L_cert_target`: `32.800343`
- `NsoftV`: `16.755160819145562`
- `leading_full_cert`: `549.5750218881353`
- `leading_half_alpha_inv_cert`: `274.78751094406766`
- `DeltaF_pair_raw`: `353.1851437825582`
- `normalizer_denominator`: `231310.43769729452`
- `DeltaF_phys_cert_normalized`: `0.0015268880526902793`
- `finite_correction_half_cert`: `0.0007634440263451397`
- `alpha_inv_pred_blind_v13`: `274.788274388094`
- `correction_to_leading_ratio`: `2.7783068587150485e-06`
...
Input/source: `BEMv8 subrun=outputs_routeB_BEM_v18_production\runs\7_1\bemv8_base`

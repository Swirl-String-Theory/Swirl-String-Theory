...
- `reference`: `0_1`
- `normalizer`: `M_Lcert2`
- `L_cert_target`: `28.915367`
- `NsoftV`: `16.755160819145562`
- `leading_full_cert`: `484.48162422961457`
- `leading_half_alpha_inv_cert`: `242.24081211480728`
- `DeltaF_pair_raw`: `240.2989903864684`
- `normalizer_denominator`: `179761.16648010814`
- `DeltaF_phys_cert_normalized`: `0.001336768085631327`
- `finite_correction_half_cert`: `0.0006683840428156635`
- `alpha_inv_pred_blind_v13`: `242.2414804988501`
- `correction_to_leading_ratio`: `2.759171904108753e-06`
...
Input/source: `BEMv8 subrun=outputs_routeB_BEM_v18_production\runs\6_1\bemv8_base`

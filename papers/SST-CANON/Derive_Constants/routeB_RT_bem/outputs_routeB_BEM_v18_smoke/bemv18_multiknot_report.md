...
- `3` valid BEMv13 budgets

## Certificate

- `selected_exponent_a`: `1.0`
- `selected_exponent_b`: `2.0`
- `selected_formula`: `M^1 L^2`
- `selected_score`: `1.1981891411233212`
- `canonical_formula`: `M^1 L^2`
- `canonical_score`: `1.1981891411233212`
- `canonical_slope_logR_vs_logL`: `0.37270219548628813`
- `canonical_corr_logR_logL`: `0.023462879100552243`
- `canonical_max_subleading_ratio`: `0.015462162987919338`

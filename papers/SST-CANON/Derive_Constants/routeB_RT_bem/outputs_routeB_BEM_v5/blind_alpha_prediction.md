...
- input path: `outputs_routeB_BEM_v5\idealxml_sampled_ideal_used.txt`
...
- `M_min`: `256`
- `M_max`: `639`
- `rms`: `0.0004783276764789429`
- `S_inf`: `-0.511275205326749`
- `S_inf_se`: `0.013721801548450135`
- `alpha_inv_pred_blind`: `-0.2556376026633745`

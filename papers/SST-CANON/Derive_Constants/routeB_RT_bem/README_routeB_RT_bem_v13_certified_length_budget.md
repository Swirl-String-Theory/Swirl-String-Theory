...
BEMv13 implements the certified-length branch suggested by BEMv12 isolated by BEMv10.
...
```bash
python routeB_RT_bem_v13_certified_length_budget.py   --ideal ideal.txt   --outdir outputs_routeB_BEM_v10   --n-center-list 24,32,40,48   --n-theta-list 5,6,7,8   --n-sphere-list 96,144,196,256   --tube-fraction-list 0.35,0.30,0.25,0.20   --outer-factor-list 2.4,2.8,3.2,3.6   --length-samples 24000   --pair-fit-min-M 10
```

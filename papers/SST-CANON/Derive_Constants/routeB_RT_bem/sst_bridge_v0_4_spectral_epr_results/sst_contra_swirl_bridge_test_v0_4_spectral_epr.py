...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--input-dir", default=".", help="Directory containing CASTLE-NWU-UNIPR-Eckvahl-Science2023-Fig*.txt files.")
    p.add_argument("--pattern", default="CASTLE-NWU-UNIPR-Eckvahl-Science2023-Fig*.txt", help="Glob pattern for input files.")
    p.add_argument("--outdir", default="./sst_bridge_v0_4_spectral_epr_results", help="Output directory.")

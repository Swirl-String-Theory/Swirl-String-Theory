...
- `reference`: `0_1`
- `normalizer`: `M_Lcert2`
- `L_cert_target`: `28.354929`
- `NsoftV`: `16.755160819145562`
- `leading_full_cert`: `475.09139541045425`
- `leading_half_alpha_inv_cert`: `237.54569770522713`
- `DeltaF_pair_raw`: `240.2989903864684`
- `normalizer_denominator`: `172860.4296979338`
- `DeltaF_phys_cert_normalized`: `0.0013901330154413047`
- `finite_correction_half_cert`: `0.0006950665077206523`
- `alpha_inv_pred_blind_v13`: `237.54639277173484`
- `correction_to_leading_ratio`: `2.9260328199383657e-06`
...
Input/source: `BEMv8 subrun=outputs_routeB_BEM_v18_knotplot\runs\6_1\bemv8_base`

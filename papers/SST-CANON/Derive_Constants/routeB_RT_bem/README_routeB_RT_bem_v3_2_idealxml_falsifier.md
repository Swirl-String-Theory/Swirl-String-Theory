...
```bash
python routeB_RT_bem_v3_2_idealxml_falsifier.py   --source file   --ideal ideal.txt   --ideal-xml-knot-ids all   --sstcore-max-knots 10   --outdir outputs_routeB_correct_ideal_all10
```

% SST-CANON-v0.8.0-Appendix.tex
% Supplemental appendix module for Swirl-String-Theory Canon-v0.8.0
...
\end{enumerate}
It is deliberately not promoted in v0.8.0 to the same status as the primitive constant chain, the Swirl-Clock, or the delay-selection sector.

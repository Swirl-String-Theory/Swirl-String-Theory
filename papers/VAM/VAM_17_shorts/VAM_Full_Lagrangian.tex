...
%----------------------------- (3) FERMIONIC KNOTS AND GAUGE COUPLINGS
    ...
    \[
        m_K=\frac{4}{\alpha\varphi}\Big(\tfrac{1}{2}\rho_{\!E} C_e^2\Big)\, V_K \,\xi(n_K)
...
%----------------------------- DIMENSIONAL NORMALIZATION
    ...
    \[
        ...
        v_\text{sw}^2=\chi\,\rho_{\mkern-2mu\scriptscriptstyle\boldsymbol\!E}\, C_e^{-2},
    \]
...
%   G_\text{swirl} = (\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} c^5 t_p^2)/(2 F_{\max} r_c^2)

# Merge VAM-3 main + sections/*.tex + manual thebibliography from ../references.bib
from __future__ import annotations

import re
from pathlib import Path

ROOT = Path(r"c:/workspace/projects/SwirlStringTheory/papers/VAM/VAM_3_Benchmarking_Relativity")
MAIN = ROOT / "VAM-3-Benchmarking_Vortex_Æther_Model_vs_General_Relativity.tex"
BIB = Path(r"c:/workspace/projects/SwirlStringTheory/papers/VAM/references.bib")

ALIASES = {
    "iskandarani2025VAM2": "iskandarani2025vam2",
    "iskandarani2025VAM3": "iskandarani2025VAM3",
    "ashby2003": "ashby2003relativity",
    "adelberger2003": "adelberger2003tests",
    "shapiro2004": "shapiro2004gravitational",
    "pound1960": "pound1960apparent",
    "cottam2002": "cottam2002gravitational",
    "vesely2001": "vesely2001solar",
    "greenstein1971": "greenstein1971gravitational",
    "ciufolini2004": "ciufolini2004confirmation",
    "eubanks1997": "eubanks1997vla",
    "will2014": "will2014confrontation",
    "sereno2006": "sereno2006solar",
}
...
def main() -> None:
    ...
    m_start = re.search(r"\\input\{sections/", main_txt)
    m_end = re.search(

...
\begin{equation}
    \mu_{\rm VAM} = q_e \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} r_c^2, \qquad
...
\begin{equation}
    \hbar_{\rm VAM} = 2 m_e \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} a_0, \quad \alpha = 2C_e/c
\end{equation}

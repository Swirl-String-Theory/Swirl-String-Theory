...
\subsection{In termen van \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \)}
Met \( \kappa = \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} r_c \), volgt:
\begin{equation}

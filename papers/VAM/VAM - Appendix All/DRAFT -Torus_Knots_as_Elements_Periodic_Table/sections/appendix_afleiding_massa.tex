...
\subsection{Expressie in termen van \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \)}
Met de definitie \( \kappa = \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} r_c \), wordt dit:
\begin{equation}

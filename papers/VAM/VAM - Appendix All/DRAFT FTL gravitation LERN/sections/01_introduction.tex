...
\begin{itemize}
    \item \textbf{$C_e$ (vortex tangential velocity constant)}: $\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \approx 1.0938456\times10^6~\text{m/s}$, setting a characteristic speed for Æther circulation (comparable to $10^{-3}c$). This appears in vortex solutions and time dilation formulas as a limiting swirl speed.

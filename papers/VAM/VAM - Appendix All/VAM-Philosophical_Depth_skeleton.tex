...
\begin{document}
   ...
   \newpage \tableofcontents
    ...
    \newpage \section*{Part I}\label{sec:part-1}   \input{sections/010_extension_physics}
    ...
    \newpage \section*{Part II}\label{sec:part-2} \input{sections/100_derevation_Gswirl}

...
\[
 c \;\stackrel{?}{=}\; \sqrt{ \frac{F_{\max}}{\rho_{\scriptscriptstyle \mathrm{Æ}}\,(\text{length scale})} } \;\;\;\text{or}\;\;\; c \;=\; \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \;\times\; \bigl(\text{dimensionless ratio of energies}\bigr).
\]

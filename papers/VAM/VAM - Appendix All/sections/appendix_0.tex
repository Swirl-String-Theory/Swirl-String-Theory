...
\begin{itemize}
    \item $\rho_{\scriptscriptstyle\boldsymbol\!f}$: mass density akin to a classical fluid.
...
\[
\rho_{\scriptscriptstyle\boldsymbol\!f} = \frac{2 m_e c^2}{\left(\alpha \cdot \frac{m_e c^2}{\hbar}\right)^2 R_c^3} \approx 7 \times 10^{-7} \text{ kg m}^{-3}
\]
...
\[
\Delta P = -\frac{\rho_{\scriptscriptstyle\boldsymbol\!f}}{2} \nabla |\vec{\omega}|^2
\]

\paragraph{Refractive Index Shifts}
\[
\Delta n = \frac{\rho_{\scriptscriptstyle\boldsymbol\!E} |\vec{\omega}|^2}{c^2}
\]

\paragraph{Vortex Mass}
\[
M_{\text{vortex}} = \int_V \frac{\rho_{\scriptscriptstyle\boldsymbol\!E}}{2} |\vec{\omega}|^2 \, dV
\]

\section{Conclusion}

Using quantum constants to define Æther properties bridges microscopic and cosmological theories. The refined value of $\rho_{\scriptscriptstyle\boldsymbol\!f}$ supports both theoretical elegance and experimental plausibility.

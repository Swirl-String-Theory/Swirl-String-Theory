...
% ============= Begin of content ============
\section{\papertitle}
In the Vortex Æther Model (VAM), the constant \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \) --- the core tangential swirl velocity --- plays a role analogous to the speed of light \( c \) in relativity. It governs the scale at which internal vortex motion couples to inertial effects, mass, and time evolution. Its square, \( C_e^2 \), appears throughout the theory as a natural denominator wherever kinetic, energetic, or gravitational effects emerge.
...
\begin{itemize}
    ...
    \[ G \sim \frac{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} c^5 t_p^2}{2 F_{\text{max}} r_c^2} \]
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \hline
        Limiting speed & \( c \) & \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \) \\

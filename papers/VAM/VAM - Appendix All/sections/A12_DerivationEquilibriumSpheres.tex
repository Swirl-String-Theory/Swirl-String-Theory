...
\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} = \frac{F_{\max}}{R_c}

which normalizes force over a characteristic length, giving:

\Delta \left( \frac{2}{3} \pi \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} R_c^3 + \frac{1}{3} \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} R_c^2 \right) = Q - W

Thus, the generalized energy equation for the equilibrium spheres is:

\Delta U = Q - W = \Delta \left( \frac{2}{3} \pi \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} R_c^3 + \frac{1}{3} \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} R_c^2 \right)

...
\begin{document}
    ...
    Let \( \rho_c \) denote the energy density of the vortex core, and let \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \) be the characteristic tangential excitation speed of a stabilized vortex filament. Then, the energy density per unit volume is given by:
    ...
    \begin{equation}
        \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \longmapsto \frac{C_e}{\varphi^k}, \quad \text{so that} \quad \text{energy density} \propto \frac{1}{\varphi^{2k}}.
    \end{equation}
    ...
    Here, \( \rho_c \) is the energy density of the core medium, and \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \) is the characteristic tangential velocity of filament excitation.
    ...
    \begin{enumerate}
        \item Tangential filament excitation \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \)
    ...
    \begin{align*}
        ...
        \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} &= 1.09384563 \times 10^6~\mathrm{m/s} \quad &\text{(core excitation speed)} \\
    ...
    In the Vortex String Theory, the invariant swirl speed at the boundary of a knotted vortex structure is denoted by \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \). We show here that it arises directly from fundamental constants by modeling the electron as a rotating vortex core.
    ...
    \begin{equation}
        \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} = r_c \cdot \omega_C
    \end{equation}
    ...
    \begin{align}
        \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} &= \left(1.4089701631 \times 10^{-15}~\text{m}\right) \cdot \left(7.76344 \times 10^{20}~\text{rad/s}\right) \nonumber \\
        \Rightarrow \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} &\approx \boxed{1.09384563 \times 10^6~\text{m/s}}
    \end{align}
    ...
    \begin{equation}
        \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} = \frac{e^2}{8\pi\varepsilon_0 \hbar}
    \end{equation}

    This expression confirms that \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \) is a derived constant, linking electromagnetism and quantum theory via vortex geometry.

    \subsection*{Experimental Confirmation in Condensed Matter Systems}

    Several experimental studies have confirmed the swirl velocity relation \( C = f \cdot \Delta x \approx \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \) within optical levitation and surface acoustic wave systems.

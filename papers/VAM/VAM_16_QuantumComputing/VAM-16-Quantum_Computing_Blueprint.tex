...
Swirl Clocks govern internal timing without external RF pulses. Gate operations are implemented via swirl-knot reconnection and Kelvin-mode interference \cite{Anderson2001,Berloff2014}. The phase evolution \( S(t) = \Omega t \) with \( \Omega = \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} / r_c \) determines operational fidelity.

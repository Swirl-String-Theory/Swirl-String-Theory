...
The SST mass of a particle or atomic structure is given by:
  ...
  \begin{equation}
      \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \longmapsto \frac{C_e}{\varphi^k} \quad \text{(in the energy density only).}
  \end{equation}

...
\frac{1}{2} \rho_{\scriptscriptstyle\boldsymbol\!f} \left( \frac{\partial S}{\partial t} \right)^2
- \frac{1}{2} \rho_{\scriptscriptstyle\boldsymbol\!f} C_e^2 \left( \frac{\partial S}{\partial x} \right)^2
+ \Lambda \cdot \{ S(t), t \}
\right]
\]
...
\[
M = \frac{1}{C_e^2} \int \rho_{\scriptscriptstyle\boldsymbol\!f} \left( \frac{\partial S}{\partial t} \right)^2 dt
\]

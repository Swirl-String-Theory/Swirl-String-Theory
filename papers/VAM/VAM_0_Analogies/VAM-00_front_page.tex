...
% COSMOLOGY
                \node[draw, rounded corners, fill=blue!13] (cosmo) at (7, -7.5) {%
...
% Connections
    ...
    \begin{multicols}{2}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item \textbf{Newton's constant:} $G = \dfrac{\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} c^3 t_p^2}{r_c m_e}$
...
\end{center}
    ...
    \begin{tikzpicture}[scale=1.3, x=1cm, y=1cm]
        ...
        \node[anchor=west, red] at (-6,-1.5) {Core: $r_c, C_e, \rho_{\scriptscriptstyle\boldsymbol\!f}$};
        \node[anchor=west, red] at (-6,-2) {\rho_{\scriptscriptstyle\boldsymbol\!m}$};
        \node[anchor=west, red] at (-6,-2.5) {\rho_{\scriptscriptstyle\boldsymbol\!E}$};

% Outer shell annotation
        \draw[thick, pink!80!black, ->]

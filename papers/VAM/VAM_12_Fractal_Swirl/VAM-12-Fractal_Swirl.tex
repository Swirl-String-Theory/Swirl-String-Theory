...
% ============= Begin of content ============
    ...
    \]
    where \( \rho_{\scriptscriptstyle\boldsymbol\!E}\) is the energy-carrying æther density and \( r_c \) is the vortex core radius. The action for the vortex field \( \omega(x) \) becomes:
    \[
    ...
    \[
        M = \frac{1}{\varphi} \cdot \frac{4}{\alpha} \cdot \left( \frac{1}{2} \rho_{\scriptscriptstyle\boldsymbol\!E}C_e^2 V_k \right),
    \]
    ...
    \[
        M_k = \frac{2}{\varphi \alpha} \cdot \rho_{\scriptscriptstyle\boldsymbol\!E}C_e^2 V_0 \left( \frac{r_k}{r_c} \right)^{D_\text{swirl}(k)}.
    \]
    ...
    \[
        \delta \rho_\text{vac}^{\text{eff}} \sim \rho_{\scriptscriptstyle\boldsymbol\!E}e^{-L / L_\text{swirl}},
    \]
    ...
    \[
        \rho_{\text{vac}}^{\text{eff}} \sim \rho_{\scriptscriptstyle\boldsymbol\!E}e^{-L / L_\text{swirl}},
    \]

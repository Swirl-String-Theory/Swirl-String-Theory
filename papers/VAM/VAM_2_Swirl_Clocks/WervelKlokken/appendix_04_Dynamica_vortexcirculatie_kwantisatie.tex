...
Voor een stationaire wervelconfiguratie met kernstraal \( r_c \) en maximale tangentiële snelheid \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \), volgt uit symmetrie:

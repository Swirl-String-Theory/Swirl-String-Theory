...
\end{equation}
waarbij \( \Omega = \frac{C_e}{r_c} \) de kernrotatie is, met \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \approx \SI{1.094e6}{m/s} \) en \( r_c \approx \SI{1.409e-15}{m} \).

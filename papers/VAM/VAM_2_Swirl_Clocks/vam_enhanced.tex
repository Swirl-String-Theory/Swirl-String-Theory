...
\begin{equation}
\boxed{
    ds^2 = \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}}^2 dT_v^2 - dr^2
}
...
\begin{tcolorbox}[title=Temporal Modes in the Vortex Æther Model, colback=gray!10, colframe=black!70]
\begin{itemize}
...
The Vortex Æther Model reinterprets relativistic and gravitational phenomena through fluid dynamics and internal topological clocks, offering a dual causality framework — radiative (\( c \)) and internal (\( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \)) — with falsifiable predictions in high-vorticity regimes.

...
\end{equation}
where \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \) is the core swirl velocity constant. In the bubble center (\( r_s = 0 \)), this implies minimal time dilation. The function \( f(r_s, t) \) acts as a modulator of the local flow.

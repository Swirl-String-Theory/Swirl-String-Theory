...
%==============================
    ...
    \end{equation}
    which makes \eqref{eq:Gamma_quant} imply $\Delta\theta=2\pi n$ around any vortex core and fixes $\lambda_\text{\ae}=\kappa_\text{\ae}/(2\pi)=\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} r_c$. Define the VAM wavefunction
    \begin{equation}

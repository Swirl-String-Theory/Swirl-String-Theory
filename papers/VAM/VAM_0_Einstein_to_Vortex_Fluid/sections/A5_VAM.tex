...
\begin{itemize}
    ...
    \[
        U_{\text{vortex}} = \frac{1}{2} \rho_{\scriptscriptstyle\boldsymbol\!E}|\boldsymbol{\omega}|^2
    \]
    \item Time dilation near such a structure follows:
    \[
        \frac{d\tau}{dt} = \sqrt{1 - \frac{U_{\text{vortex}}}{U_{\text{max}}}} = \sqrt{1 - \frac{1}{2U_{\text{max}}} \rho_{\scriptscriptstyle\boldsymbol\!E}|\boldsymbol{\omega}|^2}
    \]

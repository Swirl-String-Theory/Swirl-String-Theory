...
In the Vortex Æther Model, we alternatively derive the electron's inertial mass from the internal kinetic energy of a stable, quantized vortex knot (e.g., trefoil). The vortex stores rotational energy based on the swirl velocity \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \) and the fluid density of the æther.

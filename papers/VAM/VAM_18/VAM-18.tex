...
The kinetic energy of a vortex occupying volume \( V \) with characteristic tangential velocity \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \) is given by:
...
\item \( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \) is the maximum tangential vortex velocity (postulated as a limiting swirl speed),

# Merge VAM-5 main + Sections/Appendix inputs + manual thebibliography from ../references.bib
from __future__ import annotations

import re
from pathlib import Path

ROOT = Path(r"c:/workspace/projects/SwirlStringTheory/papers/VAM/VAM_5_Lagrangian_Gravity_Electromagnetism")
MAIN = ROOT / "VAM-5-OnAVortexBasedLagrangianUnificationGravityElectromagnetism.tex"
BIB = Path(r"c:/workspace/projects/SwirlStringTheory/papers/VAM/references.bib")

ALIASES = {
    "Ranada1989": "ranada1989",
}

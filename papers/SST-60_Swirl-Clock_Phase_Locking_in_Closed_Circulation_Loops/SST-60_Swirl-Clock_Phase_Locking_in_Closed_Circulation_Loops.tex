...
\usepackage{siunitx}
% hyperref and geometry are loaded by sn-jnl; do not reload to avoid option clash
...
\author{\fnm{Omar} \sur{Iskandarani}}
\equalcont{\footnotesize \orgname{Independent Researcher}, \orgaddress{\city{\papercity}, \country{\papercountry}}\\ \tiny ORCID: \paperorcid, doi: \paperdoi }

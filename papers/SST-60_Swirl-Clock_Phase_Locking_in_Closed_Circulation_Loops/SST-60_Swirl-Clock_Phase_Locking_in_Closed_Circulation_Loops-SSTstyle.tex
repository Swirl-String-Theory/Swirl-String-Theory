...
% footer anchored near bottom of the first page
\newcommand{\titlepageFooter}{
    \begin{textblock*}{1\textwidth}(0.15\textwidth,1.1\textheight)
    \raggedright\footnotesize
    \renewcommand{\arraystretch}{1.0}%
    \noindent\rule{\textwidth}{0.4pt}\\[0.5em]
    \textsuperscript{\textbf{*}} Email: \texttt{\paperemail}  ORCID: \texttt{\href{https://orcid.org/\paperorcid}{\paperorcid}}
    DOI: \href{https://doi.org/\paperdoi}{\paperdoi}\\    Keywords: \paperkeywords
    \end{textblock*}
}
%=========================================
...
%=========================================
    ...
    \section{Delay-Induced Discreteness vs. Boundary Quantization}
        ...
        The emergence of discrete spectrums in physical theories is traditionally attributed to either geometric boundary conditions or canonical quantization postulates \cite{Zettl2005,Griffiths2018}.

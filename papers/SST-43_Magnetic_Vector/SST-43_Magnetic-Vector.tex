...
\]
With your constants
\( \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} = 1.09384563\times 10^{6}\,\mathrm{m\,s^{-1}}\),
...
Let $r_c \mapsto \lambda r_c$ and $\mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \mapsto \mu C_e$. Then
\[
...
\[
    \Gamma_0 = 2\pi r_c \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} \;\approx\; 9.68\times10^{-9}\ \mathrm{m^2\,s^{-1}},
\]
...
\paragraph{Scalings and limits.}
    ...
    $\partial\ln\rho_{\!E}/\partial\ln \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}} = 2$,

...
% === Metadata ===
\newcommand{\papertitle}{Swirl--String Theory Rosetta Stone v0.6: \\Translation Guide for Symbols, Macros, and Constants}
\newcommand{\paperdoi}{10.5281/zenodo.17606846}
...
\hypersetup{
    ...
    citecolor=blue,
    urlcolor=blue,
    pdftitle={SST-Rosetta-v0.6: Translation Guide for Symbols, Macros, and Constants},

...
% =====================================================================
  ...
  \section*{Addendum A: EFT Growth, Naturalness, and Flavour Projectors}
      ...
      \subsection*{A1. SST ``No–Lose'' Lemma (EFT growth $\Rightarrow$ new swirl microstructure)}
          ...
          \[
              ...
              = \hbar\,\Omega_c
              = \hbar\, \frac{\|\mathbf \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}}\|}{r_c}\, .
          \]
          \textit{Dimensional check:} $[\Omega_c]=\mathrm{s}^{-1}$,\; $[E_c]=\mathrm{J}$. Using the Canon constants
          $\|\mathbf \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}}\|=1.09384563\times10^{6}\,\mathrm{m\,s^{-1}}$, $r_c=1.40897017\times10^{-15}\,\mathrm{m}$, $\hbar=1.054571817\times10^{-34}\,\mathrm{J\,s}$, we get
          \[
      ...
      \subsection*{A2. Naturalness bookkeeping rule (quadratic sensitivity cap)}
          ...
          \]
          where $E_c=\hbar\,\|\mathbf \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}}\|/r_c$ (from A1), $E_*$ is the physical scale governed by $\mu_{\ae}^2$, and $\kappa$ is the largest loop coefficient (SST analogue of the top loop). \textit{Dimensional check:} $[\Delta_{\ae}]=1$.
  ...
  \begin{itemize}
  \item A1: $[E_c]=\mathrm{J}$; decoupling limit $r_c\!\to\!0$ with fixed $\|\mathbf \mathbf{v}_{\scriptscriptstyle\boldsymbol{\circlearrowleft}}\|$ pushes $E_c\!\to\!\infty$, restoring pure contact EFT.

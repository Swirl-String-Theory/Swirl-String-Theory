...
\begin{document}
    ...
    \newpage
        ...
        \subsection*{Interpretive layer: depleted superfluid core versus filled substrate}
        
        When orthodox superfluid physics refers to a vortex core, it usually means a core in which the order parameter or effective superfluid density is suppressed. In a Gross--Pitaevskii or BEC description, the vortex line therefore appears as a density depletion or ``hollow core'' on the scale of the healing length \(\xi\).
        
        This orthodox terminology must not be confused with the claim that the core is absolutely empty at every possible deeper level. In a strictly incompressible, non-cavitating substrate, a filled core is the natural core model: the carrier-medium elements do not form a vacuum cavity, but remain present inside a Rankine-, Hill-, or vortex-patch-like core in which vorticity is carried internally.
        
        This substrate reading is not an orthodox superfluid result. It is marked here only as a separate interpretive layer:
        \[
        \boxed{
        \text{SUBSTRATE INTERPRETATION / NON-ORTHODOX RESEARCH TRACK}.
        }
        ...
        Therefore this questionnaire distinguishes three levels:
        \[
        \text{orthodox superfluid layer: depleted order-parameter core,}
        \]
        \[
        \text{classical incompressible Euler layer: filled vortex patch or singular vortex,}
        \]
        \[
        \text{non-orthodox substrate interpretation: filled, space-filling core layer.}
        \]
        
        The phrase ``hollow core'' in the orthodox superfluid control layer therefore means:
        \[
        \boxed{
        \text{depletion of the superfluid order parameter, not necessarily an absolutely empty core.}
        }
        \]
        
        For a strictly incompressible, non-cavitating substrate, the interpretive model choice is:
        \[
        \boxed{
        \text{the vortex core is fluid-filled, not hollow.}
        }
        \]
        This last statement is not an orthodox derivation, but a substrate postulate.
        
        This choice has three direct consequences.
        
        First, circulation quantization loses its orthodox derivation. In an ordinary superfluid,
        \[
        \Gamma=n\kappa
        \]
        follows from the single-valuedness of the order-parameter phase. A classical incompressible substrate does not automatically possess such an order-parameter phase. Within the substrate interpretation, circulation quantization must therefore be introduced as a separate postulate or as a consequence of additional microstructure.
        
        Second, reconnection loses its Gross--Pitaevskii mechanism. In GP/NLSE dynamics, reconnection can occur through the phase singularity and core structure on the scale \(\xi\). In a strictly ideal filled-core Euler substrate, vortex lines are topologically frozen by Kelvin circulation conservation, so reconnection is forbidden unless an additional reconnection mechanism is postulated.
        
        Third, internal twist returns as a physical degree of freedom. For a depleted quantum core, twist of a filled internal core flow is not the same quantity as in a classical vortex tube. For a filled core, internal core flow can carry twist, so the helicity bookkeeping becomes:
        \[
        H
        =
        \Gamma^2
        ...
        \right).
        \]
        Thus depleted quantum cores and filled substrate cores predict different high-\(k\) Kelvin-wave dispersion, different core contributions to helicity, and different reconnection microphysics. This makes the substrate interpretation falsifiable rather than merely terminological.

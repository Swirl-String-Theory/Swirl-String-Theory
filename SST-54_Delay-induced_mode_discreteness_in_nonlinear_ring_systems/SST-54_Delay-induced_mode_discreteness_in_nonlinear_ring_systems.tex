...
\newcommand{\paperdoi}{10.5281/zenodo.18388698}
...
%==============================================================================
    ...
    \section*{Novelty and Conceptual Contribution}
        ...
        In any nonlinear loop with finite propagation time, feedback forces the field to self--organize into discrete plateau states. This yields effectively discrete circulation modes selected by classical delay dynamics, without assuming microscopic quantization postulates.

        To our knowledge, this provides an explicit demonstration that long-delay modulational instability can generate multistable, discrete circulation patterns in a scalar delay-feedback loop.

...
%--- SST macro prelude (local to this file/section) ------
        \newcommand{\vswirl}{\mathbf{v}_{\!\boldsymbol{\circlearrowleft}}}
...
%--------------------------------------------------------
    \subsubsection{Three-level rate model and coupled equations}
        \label{subsec:three_level_model}
        ...
        \begin{itemize}
            ...
            \item \(\kappa_{se}\) is the Swirl–EM transduction coefficient: a rate for
...
%--------------------------------------------------------
    \subsubsection{Echo solution for a decaying swirl pump}
        ...
        \begin{equation}
            ...
            N_S \, e^{-\lambda t},
            \qquad
            \lambda \equiv \gamma_{\mathrm{diss}} + \kappa_{se}.
            \label{eq:nS_decay}
        \end{equation}
        ...
        \begin{align}
            ...
            \nonumber\\[4pt]
            &=
            \frac{\kappa_{se} N_S}{\gamma_{\mathrm{cav}} - \lambda}
            \left(
        ...
        \begin{itemize}
            ...
            \item The amplitude scales linearly with \(\kappa_{se}\) and with the
        ...
        \begin{equation}
            ...
            =
            \frac{\kappa_{se}}{\gamma_{\mathrm{diss}} + \kappa_{se}}
            =
            \frac{\kappa_{se}}{\lambda}.
            \label{eq:xi_definition}
        \end{equation}
        In the experimentally relevant regime where the cavity is a poor
        swirl–to–EM transducer (\(\kappa_{se} \ll \gamma_{\mathrm{diss}}\)), one has
        \(\xi \ll 1\) and almost all of the primary Unruh-like energy is lost as
        non-radiative heat in the boundaries.

%--------------------------------------------------------
    \subsubsection{Parametrization of \texorpdfstring{\(\kappa_{se}\)}{kappa\_se} via impedance mismatch}
        \label{subsec:kappa_se_impedance}

        To relate \(\kappa_{se}\) to material properties, we introduce a swirl
        impedance
        \begin{equation}
            Z_S
            \equiv
        ...
        To convert this into a \emph{rate} \(\kappa_{se}\) with dimensions of
        ...
        \(\kappa_{se} \ll \gamma_{\mathrm{diss}}\), and therefore

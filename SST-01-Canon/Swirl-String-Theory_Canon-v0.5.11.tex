...
% [Sidebar: The road ahead -- perhaps a flowchart of theory components and next steps]
    ...
    \end{equation}
    with pressure decreasing inward to provide the centripetal force.
    ...
    \begin{equation}
        \Phi(r) = -\int_{\infty}^{r} \frac{v_{\theta}(r')^2}{r'}\,dr' \,.
    \end{equation}

    Far from a vortex filament one has
    \begin{equation}
...
\addcontentsline{toc}{section}{2×2 near-degenerate solution (sketch)}

...
\[
\kappa = 2\pi r_c v_\circ,
\qquad
\tau_{\mathrm{beat}} = \frac{2\pi r_c}{v_\circ},
\qquad
\rho_{\!f} = \frac{\rho_{\!m} r_c}{v_\circ}\,\Omega
\]
...
\[
m_{K} = \rho_{\!f} v_\circ^{2}\, \Vol_{\!\mathbb{H}}(K)\,\phi^{-2k}
\]
...
\begin{tcolorbox}[title=Zero–Parameter Principle (Canonical),colback=blue!5!white,colframe=blue!75!black]
...
\mathbf{v}_{\!\boldsymbol{\circlearrowleft}} \equiv v_\circ,
\qquad
\kappa = 2\pi r_c v_\circ \\[4pt]
\text{Effective Density:}\qquad &
\rho_{\!f} = \frac{\rho_{\!m}\, r_c}{v_\circ}\, \Omega
\qquad (\text{coarse-grain rule}) \\[4pt]
\text{Mass Functional:}\qquad &
m_K = \rho_{\!f} v_\circ^{2}\, \Vol_{\!\mathbb{H}}(K)\,\phi^{-2k} \\[4pt]
\text{Gravitational Coupling:}\qquad &
G_{\mathrm{swirl}} = \frac{v_\circ c^{5} t_p^{2}}{2 F_{\mathrm{max}} r_c^{2}} \\[4pt]
...
\textbf{Corollary:}
Once $v_\circ$, $r_c$, and $\rho_{\!f}$ are fixed by a single calibration

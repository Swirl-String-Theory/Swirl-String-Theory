...
\[
\kappa = 2\pi r_c \vswirl,
\qquad
\tau_{\mathrm{beat}} = \frac{2\pi r_c}{\vswirl},
\qquad
\rho_{\!f} = \frac{\rho_{\!m} r_c}{\vswirl}\,\Omega
\]
...
\[
m_{K} = \rho_{\!f} \vswirl^{2}\, \Vol_{\!\mathbb{H}}(K)\,\phi^{-2k}
\]
...
\mathbf{v}_{\!\boldsymbol{\circlearrowleft}} \equiv \vswirl,
\qquad
\kappa = 2\pi r_c \vswirl \\[4pt]
\text{Effective Density:}\qquad &
\rho_{\!f} = \frac{\rho_{\!m}\, r_c}{\vswirl}\, \Omega
\qquad (\text{coarse-grain rule}) \\[4pt]
\text{Mass Functional:}\qquad &
m_K = \rho_{\!f} \vswirl^{2}\, \Vol_{\!\mathbb{H}}(K)\,\phi^{-2k} \\[4pt]
\text{Gravitational Coupling:}\qquad &
G_{\mathrm{swirl}} = \frac{\vswirl c^{5} t_p^{2}}{2 F_{\mathrm{max}} r_c^{2}} \\[4pt]
...
\textbf{Corollary:}
Once $\vswirl$, $r_c$, and $\rho_{\!f}$ are fixed by a single calibration
...
%========================================================================================
    ...
    \vswirl &= 1.09384563\times10^{6}~\mathrm{m/s}, & r_c &= 1.40897017\times10^{-15}~\mathrm{m},\\

...
\newcommand{\canonversion}{\textbf{v0.5.8}} % Semantic versioning: vMAJOR.MINOR.PATCH
...
%================================================
% BIBLIOGRAPHY ENTRIES (to be merged into Canon .bib)
%================================================
    \begin{thebibliography}{9}
    \bibitem{Helmholtz1858}
    H.~Helmholtz, ``Über Integrale der hydrodynamischen Gleichungen, welche den Wirbelbewegungen entsprechen,''
    \textit{J. Reine Angew. Math.} \textbf{55}, 25–55 (1858).
    doi:10.1515/crll.1858.55.25

    \bibitem{Englert1996}
    B.-G.~Englert, ``Fringe Visibility and Which-Way Information: An Inequality,''
    \textit{Phys. Rev. Lett.} \textbf{77}, 2154–2157 (1996).
    doi:10.1103/PhysRevLett.77.2154

    \bibitem{KhatiwadaQian2025}
    P.~Khatiwada and X.-F.~Qian, ``Wave-particle duality ellipse and application in quantum imaging with undetected photons,''
    \textit{Phys. Rev. Research} \textbf{7}, 033033 (2025).
...
%=====================================================
        ...
        \bibitem{Buchert2000} Buchert, T. (2000).
        On average properties of inhomogeneous fluids in general relativity: Dust cosmologies.
        \emph{Gen. Relativ. Gravit.} 32:105--125.
        doi:10.1023/A:1001800617177.

        \bibitem{Buchert2001} Buchert, T. (2001).
        On average properties of inhomogeneous cosmologies.
        \emph{Gen. Relativ. Gravit.} 33:1381--1405.
        doi:10.1023/A:1012061725841.

        \bibitem{Kelvin1869} Thomson, W. (Lord Kelvin) (1869).
        On Vortex Motion.
        \emph{Trans. Roy. Soc. Edinburgh}.
        doi:10.1017/S008045680001342X.

        \bibitem{Batchelor1967} Batchelor, G. K. (1967).
        \emph{An Introduction to Fluid Dynamics}.
        Cambridge University Press.

        \bibitem{Saffman1992} Saffman, P. G. (1992).

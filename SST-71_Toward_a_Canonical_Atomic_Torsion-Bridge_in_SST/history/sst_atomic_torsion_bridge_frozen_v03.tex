...
\end{equation}
where $h=\pm 1$ labels the handedness of the incoming torsion packet. In the starter model the linear interaction~\eqref{eq:HintTheta} is diagonal in the branch index, so the working selection rule is branch-preserving and same-handed:
\begin{equation}

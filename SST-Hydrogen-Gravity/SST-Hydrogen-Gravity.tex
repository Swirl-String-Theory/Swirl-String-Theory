    ...
    \begin{figure}[htbp]
        ...
        \begin{tikzpicture}[scale=0.90, line cap=round, line join=round]
            ...
            \tikzset{
              declare function={
                rad(\x)=\x*pi/180;
                Rx(\t)=(\R + \rtube*cos(3*rad(\t) r))*cos(rad(\t) r);
                Ry(\t)=(\R + \rtube*cos(3*rad(\t) r))*sin(rad(\t) r);
              }
            }

            % --- UNDER segments first (behind) ---
            \draw[knotunder, samples=180, smooth, variable=\ang, domain=60:120]
              plot ({1cm*Rx(\ang)}, {1cm*Ry(\ang)});
            \draw[knotunder, samples=180, smooth, variable=\ang, domain=180:240]
              plot ({1cm*Rx(\ang)}, {1cm*Ry(\ang)});
            \draw[knotunder, samples=180, smooth, variable=\ang, domain=300:360]
              plot ({1cm*Rx(\ang)}, {1cm*Ry(\ang)});

            % --- OVER segments (on top) ---
            \draw[knotover, knotarrows, samples=180, smooth, variable=\ang, domain=0:60]
              plot ({1cm*Rx(\ang)}, {1cm*Ry(\ang)});
            \draw[knotover, knotarrows, samples=180, smooth, variable=\ang, domain=120:180]
              plot ({1cm*Rx(\ang)}, {1cm*Ry(\ang)});
            \draw[knotover, knotarrows, samples=180, smooth, variable=\ang, domain=240:300]
              plot ({1cm*Rx(\ang)}, {1cm*Ry(\ang)});

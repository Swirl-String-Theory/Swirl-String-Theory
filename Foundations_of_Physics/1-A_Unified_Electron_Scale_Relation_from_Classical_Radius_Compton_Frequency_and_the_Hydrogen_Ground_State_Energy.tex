...
\begin{document}
    ...
    \section*{Appendix: A candidate gravitational coupling from the electron-scale force}
        \addcontentsline{toc}{section}{Appendix B: A candidate gravitational coupling from the electron-scale force}

        The unified electron scale relation of Appendix~A shows that
        \begin{equation}
            F_{\max}
            =
            m_e \left(\frac{\omega_C}{\alpha}\right)^2 r_e
            ...
            \label{eq:Fmax-unified-appendixB}
        \end{equation}
        where all symbols have their standard meaning as in the main text and in
        Appendix~A.
...
%---------------------------------------------------------------------------
        \subsection*{B.1 Structural force scale from a microscopic core}
            ...
            [Eq.~\eqref{eq:Fmax-unified-appendixB}].  Identifying the two,
            \begin{equation}
            ...
            Appendix~A is algebraically equivalent to the unified identity
            \eqref{eq:Fmax-unified-appendixB}.  What is new here is the possibility to
            \emph{reinterpret} \(F_{\max}\) as a structural force scale
            \(F_{\text{swirl}}^{\max}\).

%---------------------------------------------------------------------------
        \subsection*{B.2 Planck time and a candidate \(G_{\text{swirl}}\)}
            ...
            \(F_{\max}\).  Formally, combining \eqref{eq:Fmax-unified-appendixB},
...
%---------------------------------------------------------------------------
        \subsection*{B.3 Numerical consistency check}
            ...
            Eq.~\eqref{eq:Fmax-unified-appendixB} using CODATA-2018 values for
        ...
        \begin{thebibliography}{99}
            ...
            Rev.\ Mod.\ Phys.\ {\bf 93}, 025010 (2021).

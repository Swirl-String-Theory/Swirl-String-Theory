# Blender 5.x: Full torus with 6 carved grooves (3-phase + 3 mirrored) - 4 PIECES VERSION
# v4: geometry + boolean application are context-safe (evaluated mesh), and lane offsets are MAJOR-angle (theta0)
# This version splits the grooved torus into 4 pieces, each with a square bottom plate
#
# OUTPUT:
#   - torus_grooved_piece_01.stl
#   - torus_grooved_piece_02.stl
#   - torus_grooved_piece_03.stl
#   - torus_grooved_piece_04.stl
#   - torus_grooved_4pieces.blend
#
...
def main():
    ...
    for i, piece in enumerate(pieces, 1):
        ...
        print(f"  Exported: {filename} ({len(piece.data.vertices)} verts, {len(piece.data.polygons)} faces)")

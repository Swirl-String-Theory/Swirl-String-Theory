// rodin_mold_clamshell_knot512_minor120_sink.scad
// True-groove clamshell mold for 6-lane (5,12) Rodin coil:
// - 3 phases separated by 120° around the *minor circle* (equivalent to 4/12 slot offset)
// - mirrored set (optional, already in points)
// - groove cutters are pre-sunk inward in the points file to keep a thicker outer skin
//
// Files required in same folder:
//   - rodin_lanes_points_knot512_minor120_sink.scad  (generated)
//
// Render/export:
//   - Set PART = "TOP" or "BOTTOM" or "FULL"
//   - F6 (Render) then Export STL
//
// Notes: OpenSCAD booleans can be slow. Start with $fn=36 for preview, then increase.

include <rodin_lanes_points_knot512_minor120_sink.scad>;

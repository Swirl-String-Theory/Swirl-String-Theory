...
def export_stl(obj, filepath):
    ...
    # Prefer Blender 4/5 operator if present
    ...
    # Fallback for older versions / addon operator
    ...
    raise RuntimeError("No STL export operator found. Enable the STL addon or use File > Export > STL manually.")

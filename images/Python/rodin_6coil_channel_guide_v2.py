...
R_MAJOR = 33.55      # mm (tuned so fences stay within 90 mm XY)
R_TUBE  = 9.0        # mm
...
WIRE_DIAMETER = 0.8       # mm baseline (typical enamel copper)
WIRE_CLEARANCE = 0.3      # mm
...
# Output names
OUT_FULL = "rodin_6coil_channel_guide_full_v2.stl"
OUT_TOP = "rodin_6coil_channel_guide_top_v2.stl"
OUT_BOTTOM = "rodin_6coil_channel_guide_bottom_v2.stl"
OUT_PNG = "rodin_6coil_channel_guide_preview_v2.png"

# Refactored for optional SSTbindings acceleration (biot_savart + dipole grid kernels if available).
...
# --- Optional SSTbindings (if present) ---
...
# Patch: fix NumPy fallback broadcasting in dipole evaluator (keeps SSTbindings pathway unchanged).
# C++/bindings (if used): ./src/field_kernels.cpp, ./src/field_kernels.h
# PyBind11: ./src_bindings/py_field_kernels.cpp
